 ...
 *
 * @since 2.0
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.7-M0/modules/library/metadata/src/main/java/org/geotools/math/Line.java $
...
public class Line implements Cloneable, Serializable {
     ...
     */
    public double setLine(final double[] x, final double[] y) throws Exception {
